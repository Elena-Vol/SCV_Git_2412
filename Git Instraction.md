...
```
5. Сщздаем новую ветку, куда будем вносить все наши изменения. И переходим в эту ветку

6. Проверяем, что мы стоим в новой ветке, вносим изменения: можно добавить/создать или скопировать свой файл
7. сохраняем эти внесенный изменения
8. Проверяем, что в нашей ветке все сохранилось
